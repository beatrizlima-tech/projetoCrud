...
public class ProdutoRepository {
	...
	public void inserir(Produto produto) {
		...
		try {
			...
			// Preparando o comando SQL para ser executado banco de dados 
	...
	public void atualizar(Produto produto) {
		...
		try {
			...
			// Escrever o comando SQL para atulizar um produto 
			var sql = """
			...
			if(rowsAffected == 1) { // Se produto foi modificado
	...
	public void excluir(Integer id) {
		...
		try {
			...
			var rowsAffected = statement.executeUpdate(); // exectuteUpdate diz quantos registros foram afetados
	...
	/*
	 * Método para consultar e imprimir os dados de 
	 * todos os produtos contido no banco de dados
	 */
